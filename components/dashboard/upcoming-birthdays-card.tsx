// components/dashboard/upcoming-birthdays-card.tsx
'use client';

import { useEffect, useState } from 'react';
import { getUpcomingBirthdays, runBirthdayAutomation, type UpcomingBirthday, type BirthdayAutomationResult } from '@/lib/birthdays';
    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm p-4 flex flex-col h-full">
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-[11px] text-slate-500">
            Based on members and guests with a date of birth.
          </p>
        </div>
        <button
          type="button"
      ...
      {result && !error && (
        <div className="mb-2 text-[11px] text-emerald-700">
          Processed {result.processedPeople} people ·
